	...
	<div class="container">
		...
		<div class="pricing-grids-info">
			<div class="pricing-grid grid-one">
				<div class="w3ls-top">
					<img src="web/images/g8.jpg" class="img-responsive" alt="">
				</div>
			...
			<div class="pricing-grid grid-two">
				<div class="w3ls-top">
					<img src="web/images/g4.jpg" class="img-responsive" alt="">
				</div>
				<div class="w3ls-bottom">
					<ul class="count">
						<h3>Newyork</h3>
			...
			<div class="pricing-grid grid-three">
				<div class="w3ls-top">
					<img src="web/images/g5.jpg" class="img-responsive" alt="">
				</div>
				<div class="w3ls-bottom">
					<ul class="count">
						<h3>Australia</h3>
			...
			<div class="zb pricing-grid grid-four">
				<div class="w3ls-top">
					<img src="web/images/g11.jpg" class="img-responsive" alt="">
				</div>
				<div class="w3ls-bottom">
					<ul class="count">
						<h3>Dubai</h3>
...
function edit_data(id)
{
    ...
    $('body').append(myClone);
		$.ajax({
			url : '{{ url("/get-banner")}}/' + id,
			type: "get",
			dataType: "JSON",
			success: function(data)
			{
				$('#img-travel').prepend('<img id="img-travel" src="'+data.travel_image+'" class="img-responsive" />')
				$('.modal-header').html(data.travel_title);
				$('#travel_text').html(data.travel_text);
				$('#myModal').modal('show'); 
